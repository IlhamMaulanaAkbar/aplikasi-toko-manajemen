...
@section('content')
    <div>
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ route('laporan.barang-masuk.print', request()->query()) }}" target="_blank"
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="GET" class="row mb-4 g-2 d-flex justify-content-center">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('laporan.barang-masuk.index') }}" class="btn btn-sm btn-primary w-100">
                            Reset
                        </a>
                    </div>
                        ...
                        <table class="table table-striped nowrap">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th class="fs-2 fw-semibold">Supplier</th>
                            ...
                            <tbody>
                                @foreach ($barangMasuk as $item)
                                    <tr class="text-center">
                                        ...
                                        <td class="fs-2 fw-semibold">
                                            {{ $item->batch->produk->kode_produk }}
                                        </td>

                                        <td class="fs-2 fw-semibold">
                                            {{ $item->batch->produk->nama_produk }}
                                        </td>
