...
@section('content')
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="fw-semibold mb-0">Data Barang Keluar</h5>
                ...
                <table class="table table-bordered text-center">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="fs-2 fw-semibold mb-0">Tujuan</th>
                    ...
                    <tbody>
                        @forelse($barangKeluar as $i => $bk)
                            <tr>
                                ...
                                <td class="fs-2 fw-medium mb-0">
                                    {{ $bk->batch?->produk?->nama_produk ?? '-' }}
                                </td>

                                <td class="fs-2 fw-medium mb-0">
                                    {{ $bk->batch?->nomor_batch ?? '-' }}
                                </td>
                                ...
                                <td class="fs-2 fw-medium mb-0">
                                    <a href="{{ route('barang-keluar.edit', $bk->id_keluar) }}"
                                        class="btn btn-warning btn-sm">
                                        <i class="ti ti-edit"></i>
                                    </a>

                                    <form action="{{ route('barang-keluar.destroy', $bk->id_keluar) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="fs-2 fw-medium mb-0">
                                    Belum ada data
                                </td>
                            </tr>
                        @endforelse
